...
type CreateEventInput = Omit<CalendarEvent, 'id' | 'createdAt' | 'updatedAt'>;
type UpdateEventInput = Partial<Omit<CalendarEvent, 'id' | 'createdAt' | 'updatedAt'>>;
...
declare function CalendarMonth({ value, onChange, defaultValue, selected, onSelect, defaultSelected, weekStartsOn, theme: themeProp, minDate, maxDate, disabledDates, disabled, renderDay, onMonthChange, style, events, }: CalendarMonthProps): React$1.JSX.Element;
...
declare function CalendarTimeline({ value, onChange, events, timelineConfig, theme: themeProp, onEventPress, onEventLongPress, style, }: CalendarTimelineProps): React$1.JSX.Element;
...
declare function CalendarAgenda({ value, onChange, events, agendaConfig, theme: themeProp, onEventPress, onEventLongPress, style, }: CalendarAgendaProps): React$1.JSX.Element;
...
declare function CalendarDays({ monthData, selected, onSelectDate, renderDay, minDate, maxDate, disabledDates, disabled, theme, events, }: CalendarDaysProps): React$1.JSX.Element;
...
declare namespace Calendar {
    ...
    var Timeline: typeof CalendarTimeline;
    var Agenda: typeof CalendarAgenda;
...
declare function DayCell({ day, selected, disabled, onPress, onLongPress, theme, events, }: DayCellProps): React$1.JSX.Element;
...
declare function EventDot({ color, size }: EventDotProps): React$1.JSX.Element;
...
declare function EventDots({ events, maxDots, dotSize }: EventDotsProps): React$1.JSX.Element | null;
...
declare const useEventStore: zustand.UseBoundStore<Omit<zustand.StoreApi<EventStore>, "setState"> & {
    setState(nextStateOrUpdater: EventStore | Partial<EventStore> | ((state: {
        events: {
            id: string;
            title: string;
    ...
    setState(nextStateOrUpdater: EventStore | ((state: {
        events: {
            id: string;
            title: string;
            description?: string | undefined;
