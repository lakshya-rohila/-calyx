...
function useCalendar(options = {}) {
  ...
  const setCurrentDate = React17.useCallback((date) => {
    setCurrentDateAction(date);
  }, [setCurrentDateAction]);
  const selectDate = React17.useCallback((date) => {
    setSelectedDateAction(date);
  }, [setSelectedDateAction]);
  const clearSelection = React17.useCallback(() => {
    clearSelectionAction();
  }, [clearSelectionAction]);
  const goToToday = React17.useCallback(() => {
    goToTodayAction();
  }, [goToTodayAction]);
  const goToDate = React17.useCallback((date) => {
    goToDateAction(date);
  }, [goToDateAction]);
  const isDateSelected = React17.useCallback((date) => {
    if (!selectedDate) return false;
    return isSameDay(date, selectedDate);
  }, [selectedDate]);
  const isDateCurrent = React17.useCallback((date) => {
...
function useMonthCalendar(options = {}) {
  ...
  const monthData = React17.useMemo(() => {
  ...
  const goToNextMonth = React17.useCallback(() => {
    goToNextMonthAction();
  }, [goToNextMonthAction]);
  const goToPreviousMonth = React17.useCallback(() => {
    goToPreviousMonthAction();
  }, [goToPreviousMonthAction]);
  const goToMonth = React17.useCallback((targetYear, targetMonth) => {
    const targetDate = new Date(targetYear, targetMonth - 1, 1);
    calendar.setCurrentDate(targetDate);
  }, [calendar]);
  const generateMonthAtOffset = React17.useCallback((offset) => {
    const targetDate = addMonths(calendar.currentDate, offset);
    return generateMonthData(targetDate, calendar.weekConfig);
  }, [calendar.currentDate, calendar.weekConfig]);
  const getMonthKey = React17.useCallback((offset) => {
    const targetDate = addMonths(calendar.currentDate, offset);
...
function useWeekCalendar(options = {}) {
  ...
  const weekData = React17.useMemo(() => {
  ...
  const goToNextWeek = React17.useCallback(() => {
    goToNextWeekAction();
  }, [goToNextWeekAction]);
  const goToPreviousWeek = React17.useCallback(() => {
    goToPreviousWeekAction();
  }, [goToPreviousWeekAction]);
  const goToWeek = React17.useCallback((targetWeekNumber, targetYear) => {
...
function formatSectionTitle(date) {
  if (dateFns.isToday(date)) {
    return `TODAY - ${dateFns.format(date, "MMMM d, yyyy")}`;
  }
  if (dateFns.isTomorrow(date)) {
    return `TOMORROW - ${dateFns.format(date, "MMMM d, yyyy")}`;
  }
  if (dateFns.isThisWeek(date, { weekStartsOn: 0 })) {
    return `${dateFns.format(date, "EEEE")} - ${dateFns.format(date, "MMMM d, yyyy")}`;
  }
  return dateFns.format(date, "MMMM d, yyyy").toUpperCase();
}
function useAgendaGrouping(events, startDate, config) {
  return React17.useMemo(() => {
    ...
    const endDate = dateFns.addMonths(startDate, futureMonths);
    const allDates = [];
    let currentDate = dateFns.startOfDay(startDate);
    const finalDate = dateFns.endOfDay(endDate);
...
function EventDots({ events, maxDots = 3, dotSize = 6 }) {
  ...
  return /* @__PURE__ */ React17__default.default.createElement(reactNative.View, { style: styles2.container }, displayEvents.map((event) => /* @__PURE__ */ React17__default.default.createElement(EventDot, { key: event.id, color: event.color, size: dotSize })));
}
...
function DayCell({
  ...
  const scaleAnim = React17.useRef(new reactNative.Animated.Value(1)).current;
  const opacityAnim = React17.useRef(new reactNative.Animated.Value(1)).current;
  const handlePressIn = () => {
    if (disabled) return;
  ...
  return /* @__PURE__ */ React17__default.default.createElement(
    ...
    /* @__PURE__ */ React17__default.default.createElement(
      ...
      /* @__PURE__ */ React17__default.default.createElement(reactNative.View, { style: styles3.cellContent }, /* @__PURE__ */ React17__default.default.createElement(
        reactNative.Text,
        {
          style: [
            styles3.text,
      ...
      ), events.length > 0 && /* @__PURE__ */ React17__default.default.createElement(EventDots, { events, maxDots: 3 }))
    )
  );
}
...
function CalendarWeekDays({ weekStartsOn, theme }) {
  ...
  return /* @__PURE__ */ React17__default.default.createElement(reactNative.View, { style: styles6.container }, orderedDays.map((day) => /* @__PURE__ */ React17__default.default.createElement(
    reactNative.View,
    {
      key: day,
      style: [
...
function CalendarDays({
  ...
  return /* @__PURE__ */ React17__default.default.createElement(reactNative.View, { style: styles7.container }, monthData.weeks.map((week, weekIndex) => /* @__PURE__ */ React17__default.default.createElement(reactNative.View, { key: weekIndex, style: styles7.week }, week.days.map((day, dayIndex) => {
    const isSelected = isDateSelected(day.date);
    const isDisabled = isDateDisabled(day.date);
    const dayEvents = getEventsForDate(day.date);
    if (renderDay) {
      return /* @__PURE__ */ React17__default.default.createElement(reactNative.View, { key: dayIndex, style: { width: theme.spacing.cellSize } }, renderDay(day));
    }
    return /* @__PURE__ */ React17__default.default.createElement(
      DayCell,
      {
...
function ThemeProvider({ theme, children }) {
  ...
  return /* @__PURE__ */ React17__default.default.createElement(ThemeContext.Provider, { value: resolvedTheme }, children);
}
function useTheme() {
  const theme = React17.useContext(ThemeContext);
  if (!theme) {
    return themes.light;
  }
  return theme;
...
function CalendarMonth({
  ...
  const [internalSelected, setInternalSelected] = React17.useState(
...
function CalendarWeek({
  ...
  return /* @__PURE__ */ React17__default.default.createElement(
    ...
    /* @__PURE__ */ React17__default.default.createElement(reactNative.View, { style: styles9.week }, calendar.weekData.days.map((day, index) => {
      const isSelected = currentSelected ? isSameDay(day.date, currentSelected) : false;
      if (renderDay) {
        return /* @__PURE__ */ React17__default.default.createElement(reactNative.View, { key: index, style: { width: resolvedTheme.spacing.cellSize } }, renderDay(day));
      }
      return /* @__PURE__ */ React17__default.default.createElement(
        DayCell,
        {
...
function TimelineGrid({
  ...
  return /* @__PURE__ */ React17__default.default.createElement(reactNative.View, { style: styles11.container }, hours.map((hour) => /* @__PURE__ */ React17__default.default.createElement(reactNative.View, { key: hour, style: styles11.hourSlot }, /* @__PURE__ */ React17__default.default.createElement(reactNative.View, { style: styles11.timeLabel }, /* @__PURE__ */ React17__default.default.createElement(
    reactNative.Text,
    {
    ...
    slotDuration === 30 && /* @__PURE__ */ React17__default.default.createElement(
      reactNative.View,
      {
        style: [
...
function TimelineEvent({
  ...
  return /* @__PURE__ */ React17__default.default.createElement(
    ...
    /* @__PURE__ */ React17__default.default.createElement(
      ...
      /* @__PURE__ */ React17__default.default.createElement(reactNative.Text, { style: styles12.title, numberOfLines: 1 }, event.title),
      showDetails && /* @__PURE__ */ React17__default.default.createElement(reactNative.Text, { style: styles12.time, numberOfLines: 1 }, formatTime(event.startDate), " - ", formatTime(event.endDate)),
      showDescription && event.description && /* @__PURE__ */ React17__default.default.createElement(reactNative.Text, { style: styles12.description, numberOfLines: 2 }, event.description)
    )
  );
}
...
function CurrentTimeLine({ startHour, showToday }) {
  const [currentMinutes, setCurrentMinutes] = React17.useState(() => {
    const now = /* @__PURE__ */ new Date();
    return now.getHours() * 60 + now.getMinutes();
  });
  const fadeAnim = React17.useRef(new reactNative.Animated.Value(0)).current;
  const topAnim = React17.useRef(new reactNative.Animated.Value(0)).current;
  React17.useEffect(() => {
    if (!showToday) return;
  ...
  React17.useEffect(() => {
    ...
    reactNative.Animated.timing(topAnim, {
      toValue: top,
      duration: 500,
  ...
  return /* @__PURE__ */ React17__default.default.createElement(
    ...
    /* @__PURE__ */ React17__default.default.createElement(reactNative.View, { style: styles13.dot }),
    /* @__PURE__ */ React17__default.default.createElement(reactNative.View, { style: styles13.line })
  );
}
...
function CalendarTimeline({
  ...
  const [internalValue, setInternalValue] = React17.useState(value || /* @__PURE__ */ new Date());
  const currentValue = value !== void 0 ? value : internalValue;
  const scrollViewRef = React17.useRef(null);
  const contextTheme = useTheme();
  const resolvedTheme = themeProp ? typeof themeProp === "string" ? themes[themeProp] : themeProp : contextTheme;
  const config = {
  ...
  return /* @__PURE__ */ React17__default.default.createElement(
    ...
    /* @__PURE__ */ React17__default.default.createElement(
      ...
      /* @__PURE__ */ React17__default.default.createElement(reactNative.View, { style: { height: totalHeight } }, /* @__PURE__ */ React17__default.default.createElement(
        TimelineGrid,
        {
      ...
      ), layouts.map((layout) => /* @__PURE__ */ React17__default.default.createElement(
        TimelineEvent,
        {
          key: layout.event.id,
          layout,
      ...
      )), showCurrentTime && /* @__PURE__ */ React17__default.default.createElement(
        CurrentTimeLine,
        {
          startHour: config.startHour,
          showToday: true
...
function AgendaSectionHeader({
  ...
  return /* @__PURE__ */ React17__default.default.createElement(
    ...
    /* @__PURE__ */ React17__default.default.createElement(reactNative.Text, { style: [styles15.title, { color: theme.colors.foreground }] }, title),
    /* @__PURE__ */ React17__default.default.createElement(reactNative.Text, { style: styles15.count }, eventCount, " event", eventCount !== 1 ? "s" : "")
  );
}
...
function AgendaEvent({
  ...
  const scaleAnim = React17.useRef(new reactNative.Animated.Value(1)).current;
  const backgroundAnim = React17.useRef(new reactNative.Animated.Value(0)).current;
  const handlePressIn = () => {
    reactNative.Animated.parallel([
      reactNative.Animated.timing(scaleAnim, {
        toValue: 0.98,
      ...
      reactNative.Animated.timing(backgroundAnim, {
        toValue: 1,
        duration: 100,
        useNativeDriver: false
      })
  ...
  return /* @__PURE__ */ React17__default.default.createElement(
    ...
    /* @__PURE__ */ React17__default.default.createElement(
      ...
      /* @__PURE__ */ React17__default.default.createElement(
        ...
        /* @__PURE__ */ React17__default.default.createElement(reactNative.View, { style: styles16.leftSection }, /* @__PURE__ */ React17__default.default.createElement(
          reactNative.View,
          {
            style: [
              styles16.colorDot,
        ...
        ), /* @__PURE__ */ React17__default.default.createElement(reactNative.View, { style: styles16.content }, /* @__PURE__ */ React17__default.default.createElement(reactNative.Text, { style: styles16.time }, timeDisplay), /* @__PURE__ */ React17__default.default.createElement(reactNative.Text, { style: styles16.title, numberOfLines: 1 }, event.title), event.description && /* @__PURE__ */ React17__default.default.createElement(reactNative.Text, { style: styles16.description, numberOfLines: 2 }, event.description), event.category && /* @__PURE__ */ React17__default.default.createElement(
          reactNative.View,
          {
            style: [
          ...
          /* @__PURE__ */ React17__default.default.createElement(reactNative.Text, { style: [styles16.categoryText, { color: event.color }] }, event.category)
        )))
      )
    )
  );
...
function CalendarAgenda({
  ...
  const [internalValue, setInternalValue] = React17.useState(value || /* @__PURE__ */ new Date());
  const currentValue = value !== void 0 ? value : internalValue;
  const [loadedMonths, setLoadedMonths] = React17.useState(agendaConfig.futureMonths || 3);
  const contextTheme = useTheme();
  const resolvedTheme = themeProp ? typeof themeProp === "string" ? themes[themeProp] : themeProp : contextTheme;
  const config = {
  ...
  const renderFooter = () => {
    return /* @__PURE__ */ React17__default.default.createElement(reactNative.View, { style: styles17.footer }, /* @__PURE__ */ React17__default.default.createElement(reactNative.ActivityIndicator, { size: "small", color: resolvedTheme.colors.primary }));
  };
  return /* @__PURE__ */ React17__default.default.createElement(
    reactNative.View,
    {
    ...
    /* @__PURE__ */ React17__default.default.createElement(reactNative.View, { style: { padding: resolvedTheme.spacing.padding } }, /* @__PURE__ */ React17__default.default.createElement(
      CalendarHeader,
      {
        year: currentValue.getFullYear(),
        month: currentValue.getMonth(),
...
function Calendar(props) {
  ...
  if (mode === "month") {
    return /* @__PURE__ */ React17__default.default.createElement(CalendarMonth, { ...rest });
  }
  if (mode === "week") {
    return /* @__PURE__ */ React17__default.default.createElement(CalendarWeek, { ...rest, showWeekNumber: showWeekNumbers });
  }
  if (mode === "day") {
    return /* @__PURE__ */ React17__default.default.createElement(CalendarDay, { ...rest });
  }
  if (mode === "timeline") {
    return /* @__PURE__ */ React17__default.default.createElement(CalendarTimeline, { ...rest });
  }
  if (mode === "agenda") {
    return /* @__PURE__ */ React17__default.default.createElement(CalendarAgenda, { ...rest });
  }
  return /* @__PURE__ */ React17__default.default.createElement(CalendarMonth, { ...rest });
}
...
var useEventStore = zustand.create()(
  immer.immer((set, get) => ({
    events: [],
    addEvent: (input) => {
      const now = /* @__PURE__ */ new Date();
...
exports.CalendarTimeline = CalendarTimeline;
exports.DayCell = DayCell;
exports.EventDot = EventDot;
exports.EventDots = EventDots;
